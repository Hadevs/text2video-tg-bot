...
client = replicate.Client(api_token="cc1669eb7f7637e42fe1d3212ab87e654d8ac819")
...
def generate_video_with_ai(start_scene, end_scene,message):
	try:
		model = client.models.get("andreasjansson/stable-diffusion-animation")
		...
		return output
	except client.exceptions.ModelError:
		bot.send_message(
        message.chat.id, 
